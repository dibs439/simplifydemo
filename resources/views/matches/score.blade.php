                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <tbody>
                                ...
                                <td><input type="number" name="fours1[]" id="fours1" class="form-control" min="0" style="width:50px;" /></td>
                                <td><input type="number" name="sixes1[]" id="sixes1" class="form-control" min="0" style="width:50px;" /></td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <tbody>
                                ...
                                <td><input type="number" name="fours2[]" id="fours2" class="form-control" min="0" style="width:50px;" /></td>
                                <td><input type="number" name="sixes2[]" id="sixes2" class="form-control" min="0" style="width:50px;" /></td>
